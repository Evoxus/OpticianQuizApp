...
function getQuestion() {
    // this will retreve the next question from the store
}

function checkAnswer() {
    // this will check the user's answer agains the correct answer determining which view goes next
}
...
function trackScore() {
    // this will incriment score based on checkAnswer result
}
